import { n as ne$1, s as se$1, T as T$2, t as te$1, a as a$2, o as oe$1, R as R$1, p as p$1, y as y$1 } from "./index.a4ba502d.js";
import { b as browser } from "./browser.80e327a5.js";
import "./index.a9e8707a.js";
/**
 * @license
...
const c = { MOBILE_BREAKPOINT: 600, WCM_RECENT_WALLET_DATA: "WCM_RECENT_WALLET_DATA", EXPLORER_WALLET_URL: "https://explorer.walletconnect.com/?type=wallet", getShadowRootElement(e2, o2) {
  ...
  return r2 != null && r2[e2] ? r2[e2] : o2 ? te$1.getWalletImageUrl(o2) : "";
  ...
  return Promise.race([o2, a$2.wait(3e3)]);
}, getErrorMessage(e2) {
  ...
  const { walletConnectUri: o2 } = p$1.state, { mobile: r2, name: a2 } = e2, t2 = r2?.native, l2 = r2?.universal;
  ...
  const { walletImages: e2 } = y$1.state, o2 = Object.values(e2 ?? {});
  ...
  const { desktop: e2, mobile: o2 } = a$2.getWalletRouterData(), r2 = Boolean(e2?.native), a2 = Boolean(e2?.universal), t2 = Boolean(o2?.native) || Boolean(o2?.universal);
  return { isDesktop: r2, isMobile: t2, isWeb: a2 };
}, goToConnectingView(e2) {
  T$2.setData({ Wallet: e2 });
  const o2 = a$2.isMobile(), { isDesktop: r2, isWeb: a2, isMobile: t2 } = c.getCachedRouterWalletPlatforms();
  o2 ? t2 ? T$2.push("MobileConnecting") : a2 ? T$2.push("WebConnecting") : T$2.push("InstallWallet") : r2 ? T$2.push("DesktopConnecting") : a2 ? T$2.push("WebConnecting") : t2 ? T$2.push("MobileQrcodeConnecting") : T$2.push("InstallWallet");
...
const Dt = { generate(e2, o2, r2) {
  ...
  $2.forEach(({ x: y2, y: u2 }) => {
    const O = (i2.length - A) * s2 * y2, b$1 = (i2.length - A) * s2 * u2, E2 = 0.45;
  ...
  i2.forEach((y2, u2) => {
    y2.forEach((O, b2) => {
      if (i2[u2][b2] && !(u2 < A && b2 < A || u2 > i2.length - (A + 1) && b2 < A || u2 < A && b2 > i2.length - (A + 1)) && !(u2 > Ne && u2 < Ze && b2 > Ne && b2 < Ze)) {
  ...
  return Se.forEach(([y2, u2]) => {
    J[y2] ? J[y2].push(u2) : J[y2] = [u2];
  }), Object.entries(J).map(([y2, u2]) => {
    const O = u2.filter((b2) => u2.every((E2) => !Ce(b2, E2, s2)));
    return [Number(y2), O];
  }).forEach(([y2, u2]) => {
    u2.forEach((O) => {
      l2.push(b`<circle cx="${y2}" cy="${O}" fill="${a2}" r="${s2 / Ve}">`);
    });
  }), Object.entries(J).filter(([y2, u2]) => u2.length > 1).map(([y2, u2]) => {
    const O = u2.filter((b2) => u2.some((E2) => Ce(b2, E2, s2)));
    return [Number(y2), O];
  }).map(([y2, u2]) => {
...
let We = class extends s {
  ...
  async preloadListings() {
    if (y$1.state.enableExplorer) {
      ...
      const { recomendedWallets: e2 } = te$1.state, o2 = e2.map((r2) => c.getWalletIcon(r2));
...
let Ie = class extends s {
  ...
  render() {
    const { recomendedWallets: e2 } = te$1.state, o2 = [...e2, ...e2], r2 = a$2.RECOMMENDED_WALLET_AMOUNT * 2;
...
const G = { manualWallets() {
  ...
  return (o2 = a$2.isMobile() ? i2?.map(({ id: s2, name: $2, links: f2 }) => ({ id: s2, name: $2, mobile: f2, links: f2 })) : i2?.map(({ id: s2, name: $2, links: f2 }) => ({ id: s2, name: $2, desktop: f2, links: f2 }))) != null ? o2 : [];
}, recentWallet() {
  return c.getRecentWallet();
}, recomendedWallets(e2 = false) {
  var o2;
  const r2 = e2 || (o2 = G.recentWallet()) == null ? void 0 : o2.id, { recomendedWallets: a2 } = te$1.state;
...
let Ee = class extends s {
  render() {
    const { explorerExcludedWalletIds: e2, enableExplorer: o2 } = y$1.state, r2 = e2 !== "ALL" && o2, a2 = Z.manualWalletsTemplate(), t2 = Z.recomendedWalletsTemplate();
...
let Me = class extends s {
  render() {
    const { termsOfServiceUrl: e2, privacyPolicyUrl: o2 } = y$1.state;
...
let Ae = class extends s {
  ...
  render() {
    const { recomendedWallets: e2 } = te$1.state, o2 = G.manualWallets(), r2 = [...e2, ...o2].reverse().slice(0, 4);
...
let me = class extends s {
  ...
  onFormatAndRedirect(e2) {
    const { desktop: o2, name: r2 } = a$2.getWalletRouterData(), a2 = o2?.native;
    if (a2) {
  ...
  openDesktopApp() {
    const { walletConnectUri: e2 } = p$1.state, o2 = a$2.getWalletRouterData();
    c.setRecentWallet(o2), e2 && this.onFormatAndRedirect(e2);
  }
  render() {
    const { name: e2, id: o2, image_id: r2 } = a$2.getWalletRouterData(), { isMobile: a2, isWeb: t2 } = c.getCachedRouterWalletPlatforms();
...
let Te = class extends s {
  ...
  render() {
    const { name: e2, id: o2, image_id: r2, homepage: a2 } = a$2.getWalletRouterData();
...
let he = class extends s {
  ...
  openMobileApp(e2 = false) {
    const { walletConnectUri: o2 } = p$1.state, r2 = a$2.getWalletRouterData();
  ...
  render() {
    const { name: e2, id: o2, image_id: r2, app: a2, mobile: t2 } = a$2.getWalletRouterData(), { isWeb: l$12 } = c.getCachedRouterWalletPlatforms(), i2 = a2?.ios, s2 = t2?.universal;
...
let je = class extends s {
  render() {
    const { name: e2, id: o2, image_id: r2 } = a$2.getWalletRouterData(), { isDesktop: a2, isWeb: t2 } = c.getCachedRouterWalletPlatforms();
...
let U = class extends s {
  ...
  isLastPage() {
    const { wallets: e2, search: o2 } = te$1.state, { listings: r2, total: a2 } = this.search ? o2 : e2;
    return a2 <= De || r2.length >= a2;
  }
  async fetchWallets() {
    var e2;
    const { wallets: o2, search: r2 } = te$1.state, { listings: a2, total: t2, page: l2 } = this.search ? r2 : o2;
...
let we = class extends s {
  ...
  onFormatAndRedirect(e2) {
    const { desktop: o2, name: r2 } = a$2.getWalletRouterData(), a2 = o2?.universal;
    if (a2) {
  ...
  render() {
    const { name: e2, id: o2, image_id: r2 } = a$2.getWalletRouterData(), { isMobile: a2, isDesktop: t2 } = c.getCachedRouterWalletPlatforms(), l$12 = a$2.isMobile();
