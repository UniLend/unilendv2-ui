import { e as events, aV as buffer$1, aW as inherits_browser, aX as require$$3, c as commonjsGlobal, aY as bn, at as Buffer$7, ar as browser$1$1, a as getAugmentedNamespace, aZ as tslib_es6, a_ as clsx_m, as as getDefaultExportFromCjs } from "./index.a9e8707a.js";
import { f as preact_module, i as hooks_module } from "./hooks.module.e4e5c71d.js";
...
classes$1.EthereumProviderError = classes$1.EthereumRpcError = void 0;
const fast_safe_stringify_1$1 = fastSafeStringify;
class EthereumRpcError$1 extends Error {
  ...
  toString() {
    return fast_safe_stringify_1$1.default(this.serialize(), stringifyReplacer$1, 2);
  }
}
classes$1.EthereumRpcError = EthereumRpcError$1;
class EthereumProviderError$1 extends EthereumRpcError$1 {
  constructor(code, message, data) {
...
classes$1.EthereumProviderError = EthereumProviderError$1;
function isValidEthProviderCode$1(code) {
  return Number.isInteger(code) && code >= 1e3 && code <= 4999;
}
function stringifyReplacer$1(_, value) {
  if (value === "[Circular]") {
    return void 0;
  }
  return value;
...
errorConstants$1.errorValues = errorConstants$1.errorCodes = void 0;
errorConstants$1.errorCodes = {
  rpc: {
    invalidInput: -32e3,
...
(function(exports2) {
  ...
  const error_constants_12 = errorConstants$1;
  const classes_12 = classes$1;
...
const classes_1$1 = classes$1;
const utils_1$1 = utils$4;
const error_constants_1$1 = errorConstants$1;
errors$1.ethErrors = {
  rpc: {
...
(function(exports2) {
  ...
  const eth_rpc_errors_12 = dist$5;
  const Web3Response_12 = Web3Response;
  const version_12 = version;
  ...
  function standardErrorMessage(code) {
    return code !== void 0 ? (0, eth_rpc_errors_12.getMessageFromCode)(code) : "Unknown error";
  }
...
var setFunctionLength = function setFunctionLength2(fn, length) {
  ...
  if (functionLengthIsConfigurable || functionLengthIsWritable || !loose) {
    if (hasDescriptors) {
      define$1(fn, "length", length, true, true);
    } else {
      define$1(fn, "length", length);
    }
  }
  return fn;
};
...
function requireBuffer_list() {
  ...
  var _require2 = require$$3, inspect2 = _require2.inspect;
...
function require_stream_writable() {
  ...
  function onwriteError(stream, state2, sync, er, cb) {
    ...
    if (sync) {
      browser$1$1.nextTick(cb, er);
      browser$1$1.nextTick(finishMaybe, stream, state2);
  ...
  function onwrite(stream, er) {
    ...
    if (er)
      ...
      if (sync) {
        browser$1$1.nextTick(afterWrite, stream, state2, finished, cb);
      } else {
...
function require_stream_readable() {
  ...
  function maybeReadMore(stream, state2) {
    if (!state2.readingMore) {
      ...
      browser$1$1.nextTick(maybeReadMore_, stream, state2);
    }
  }
  ...
  function resume(stream, state2) {
    if (!state2.resumeScheduled) {
      ...
      browser$1$1.nextTick(resume_, stream, state2);
    }
  }
  ...
  function endReadable(stream) {
    ...
    if (!state2.endEmitted) {
      state2.ended = true;
      browser$1$1.nextTick(endReadableNT, state2, stream);
    }
  }
...
inherits_browser.exports(Transform$3, Duplex);
...
inherits_browser.exports(PassThrough, Transform$2);
...
const debug$1 = typeof browser$1$1 === "object" && browser$1$1.env && {}.NODE_DEBUG && /\bsemver\b/i.test({}.NODE_DEBUG) ? (...args) => console.error("SEMVER", ...args) : () => {
};
var debug_1 = debug$1;
(function(module, exports2) {
...
const { safeRe: re$1, t: t$1 } = re$2.exports;
...
function requireComparator() {
  ...
  const parseOptions2 = parseOptions_1;
  const { safeRe: re2, t: t2 } = re$2.exports;
  const cmp2 = cmp_1;
  const debug2 = debug_1;
  const SemVer2 = semver$1;
...
class CoinbaseWalletProvider extends safe_event_emitter_1.default {
  ...
  _prepareTransactionParams(tx) {
    ...
    const data = tx.data ? (0, util_1$5.ensureBuffer)(tx.data) : Buffer$7.alloc(0);
...
const index = /* @__PURE__ */ getDefaultExportFromCjs(dist$6);
