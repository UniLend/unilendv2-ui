import { g as global, c as commonjsGlobal, a as getAugmentedNamespace, b as cjs$2, e as events, d as binary, w as wipe, r as random, f as fromString, t as toString, h as concat, i as w$1, D as Dt$1, k as kt$1, N as N$2, j as jn, l as Dn, m as kn, V as Vn$1, R as Re, F as Fn, K as Kn, x as xn, L as Ln, n as ee$1, $ as $$1, p as p$2, o as it$1, Z as Zt, J as Jn, X as Xt, _ as _$2, q as lt$1, s as Nt$1, u as bt$1, v as st$1, y as ft$2, U as U$2, z as dt$1, A as xt$1, B as jt, C as h$2, E as ut$1, G as ct$1, H as at$1, I as j$2, M as q$1, O as te, P as et$1, Q as nt$1, S as Mn, T as mt$1, W as yt$1, Y as D$3, a0 as B$1, a1 as At$1, a2 as pt$1, a3 as $t$1, a4 as er$1, a5 as Kt$1, a6 as Mt$1, a7 as cn, a8 as un, a9 as Ft$1, aa as an, ab as Vt$1, ac as Gt, ad as Ht, ae as Wt, af as Qt, ag as qt$1, ah as Bt$1, ai as zt$1, aj as Lt$1, ak as zn, al as Xe$1, am as oe$2, an as S$2, ao as ve, ap as Rn, aq as __vitePreload } from "./index.a9e8707a.js";
import { s as safeJsonStringify, a as safeJsonParse, r as requireBrowser$1, i as isWsUrl, c as cjs$3, b as isLocalhostUrl, f as formatJsonRpcError, p as parseConnectionError, J as JsonRpcProvider, d as isJsonRpcRequest, e as isJsonRpcResponse, g as formatJsonRpcResult, h as isJsonRpcResult, j as isJsonRpcError, k as formatJsonRpcRequest, l as getBigIntRpcId, m as payloadId, H as HttpConnection } from "./http.da03b187.js";
...
class WsConnection {
  ...
  register(url = this.url) {
    ...
    return new Promise((resolve, reject) => {
      const opts = !cjs$3.isReactNative() ? { rejectUnauthorized: !isLocalhostUrl(url) } : void 0;
...
const ki = lodash_isequal.exports;
function Ki(r, e) {
  if (r.length >= 255)
  ...
  var o = r.length, h2 = r.charAt(0), u2 = Math.log(o) / Math.log(256), d2 = Math.log(256) / Math.log(o);
  function p2(c2) {
    ...
    if (c2.length === 0)
      return "";
    for (var m2 = 0, z2 = 0, I2 = 0, _2 = c2.length; I2 !== _2 && c2[I2] === 0; )
      I2++, m2++;
    for (var S2 = (_2 - I2) * d2 + 1 >>> 0, b2 = new Uint8Array(S2); I2 !== _2; ) {
      for (var P2 = c2[I2], A2 = 0, C = S2 - 1; (P2 !== 0 || A2 < z2) && C !== -1; C--, A2++)
        P2 += 256 * b2[C] >>> 0, b2[C] = P2 % o >>> 0, P2 = P2 / o >>> 0;
      if (P2 !== 0)
    ...
    for (var x2 = S2 - z2; x2 !== S2 && b2[x2] === 0; )
      x2++;
    for (var q2 = h2.repeat(m2); x2 < S2; ++x2)
      q2 += r.charAt(b2[x2]);
    return q2;
  }
  function y2(c2) {
    ...
    var m2 = 0;
    if (c2[m2] !== " ") {
      for (var z2 = 0, I2 = 0; c2[m2] === h2; )
        z2++, m2++;
      for (var _2 = (c2.length - m2) * u2 + 1 >>> 0, S2 = new Uint8Array(_2); c2[m2]; ) {
        var b2 = t[c2.charCodeAt(m2)];
        if (b2 === 255)
          return;
        for (var P2 = 0, A2 = _2 - 1; (b2 !== 0 || P2 < I2) && A2 !== -1; A2--, P2++)
          b2 += o * S2[A2] >>> 0, S2[A2] = b2 % 256 >>> 0, b2 = b2 / 256 >>> 0;
        if (b2 !== 0)
          throw new Error("Non-zero carry");
        I2 = P2, m2++;
      }
      if (c2[m2] !== " ") {
        for (var C = _2 - I2; C !== _2 && S2[C] === 0; )
          C++;
        for (var x2 = new Uint8Array(z2 + (_2 - C)), q2 = z2; C !== _2; )
          x2[q2++] = S2[C++];
        return x2;
      }
    }
  ...
  return { encode: p2, decodeUnsafe: y2, decode: $2 };
}
var Bi = Ki, Vi = Bi;
const ze = (r) => {
...
const W$1 = ({ name: r, prefix: e, encode: t, decode: i }) => new Ji(r, e, t, i), K = ({ prefix: r, name: e, alphabet: t }) => {
  ...
  for (let d2 = 0; d2 < n2; ++d2) {
    ...
    h2 = h2 << t | p2, o += t, o >= 8 && (o -= 8, a2[u2++] = 255 & h2 >> o);
  }
  if (o >= t || 255 & h2 << 8 - o)
...
const rs = K({ prefix: "9", name: "base10", alphabet: "0123456789" });
...
const fs = K({ prefix: "k", name: "base36", alphabet: "0123456789abcdefghijklmnopqrstuvwxyz" }), Es = K({ prefix: "K", name: "base36upper", alphabet: "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ" });
var ws = Object.freeze({ __proto__: null, base36: fs, base36upper: Es });
const vs = K({ name: "base58btc", prefix: "z", alphabet: "123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz" }), Is = K({ name: "base58flickr", prefix: "Z", alphabet: "123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ" });
...
const Le = Array.from("\u{1F680}\u{1FA90}\u2604\u{1F6F0}\u{1F30C}\u{1F311}\u{1F312}\u{1F313}\u{1F314}\u{1F315}\u{1F316}\u{1F317}\u{1F318}\u{1F30D}\u{1F30F}\u{1F30E}\u{1F409}\u2600\u{1F4BB}\u{1F5A5}\u{1F4BE}\u{1F4BF}\u{1F602}\u2764\u{1F60D}\u{1F923}\u{1F60A}\u{1F64F}\u{1F495}\u{1F62D}\u{1F618}\u{1F44D}\u{1F605}\u{1F44F}\u{1F601}\u{1F525}\u{1F970}\u{1F494}\u{1F496}\u{1F499}\u{1F622}\u{1F914}\u{1F606}\u{1F644}\u{1F4AA}\u{1F609}\u263A\u{1F44C}\u{1F917}\u{1F49C}\u{1F614}\u{1F60E}\u{1F607}\u{1F339}\u{1F926}\u{1F389}\u{1F49E}\u270C\u2728\u{1F937}\u{1F631}\u{1F60C}\u{1F338}\u{1F64C}\u{1F60B}\u{1F497}\u{1F49A}\u{1F60F}\u{1F49B}\u{1F642}\u{1F493}\u{1F929}\u{1F604}\u{1F600}\u{1F5A4}\u{1F603}\u{1F4AF}\u{1F648}\u{1F447}\u{1F3B6}\u{1F612}\u{1F92D}\u2763\u{1F61C}\u{1F48B}\u{1F440}\u{1F62A}\u{1F611}\u{1F4A5}\u{1F64B}\u{1F61E}\u{1F629}\u{1F621}\u{1F92A}\u{1F44A}\u{1F973}\u{1F625}\u{1F924}\u{1F449}\u{1F483}\u{1F633}\u270B\u{1F61A}\u{1F61D}\u{1F634}\u{1F31F}\u{1F62C}\u{1F643}\u{1F340}\u{1F337}\u{1F63B}\u{1F613}\u2B50\u2705\u{1F97A}\u{1F308}\u{1F608}\u{1F918}\u{1F4A6}\u2714\u{1F623}\u{1F3C3}\u{1F490}\u2639\u{1F38A}\u{1F498}\u{1F620}\u261D\u{1F615}\u{1F33A}\u{1F382}\u{1F33B}\u{1F610}\u{1F595}\u{1F49D}\u{1F64A}\u{1F639}\u{1F5E3}\u{1F4AB}\u{1F480}\u{1F451}\u{1F3B5}\u{1F91E}\u{1F61B}\u{1F534}\u{1F624}\u{1F33C}\u{1F62B}\u26BD\u{1F919}\u2615\u{1F3C6}\u{1F92B}\u{1F448}\u{1F62E}\u{1F646}\u{1F37B}\u{1F343}\u{1F436}\u{1F481}\u{1F632}\u{1F33F}\u{1F9E1}\u{1F381}\u26A1\u{1F31E}\u{1F388}\u274C\u270A\u{1F44B}\u{1F630}\u{1F928}\u{1F636}\u{1F91D}\u{1F6B6}\u{1F4B0}\u{1F353}\u{1F4A2}\u{1F91F}\u{1F641}\u{1F6A8}\u{1F4A8}\u{1F92C}\u2708\u{1F380}\u{1F37A}\u{1F913}\u{1F619}\u{1F49F}\u{1F331}\u{1F616}\u{1F476}\u{1F974}\u25B6\u27A1\u2753\u{1F48E}\u{1F4B8}\u2B07\u{1F628}\u{1F31A}\u{1F98B}\u{1F637}\u{1F57A}\u26A0\u{1F645}\u{1F61F}\u{1F635}\u{1F44E}\u{1F932}\u{1F920}\u{1F927}\u{1F4CC}\u{1F535}\u{1F485}\u{1F9D0}\u{1F43E}\u{1F352}\u{1F617}\u{1F911}\u{1F30A}\u{1F92F}\u{1F437}\u260E\u{1F4A7}\u{1F62F}\u{1F486}\u{1F446}\u{1F3A4}\u{1F647}\u{1F351}\u2744\u{1F334}\u{1F4A3}\u{1F438}\u{1F48C}\u{1F4CD}\u{1F940}\u{1F922}\u{1F445}\u{1F4A1}\u{1F4A9}\u{1F450}\u{1F4F8}\u{1F47B}\u{1F910}\u{1F92E}\u{1F3BC}\u{1F975}\u{1F6A9}\u{1F34E}\u{1F34A}\u{1F47C}\u{1F48D}\u{1F4E3}\u{1F942}"), xs = Le.reduce((r, e, t) => (r[t] = e, r), []), Os = Le.reduce((r, e, t) => (r[e.codePointAt(0)] = t, r), []);
function As(r) {
...
const Ns = W$1({ prefix: "\u{1F680}", name: "base256emoji", encode: As, decode: zs });
...
const ue = "wc", We = 2, X$1 = "core", O$1 = `${ue}@2:${X$1}:`, Xe = { name: X$1, logger: "error" }, Qe = { database: ":memory:" }, Ze = "crypto", le$1 = "client_ed25519_seed", et = cjs$2.ONE_DAY, tt = "keychain", it = "0.3", st = "messages", rt = "0.3", nt = cjs$2.SIX_HOURS, at = "publisher", ot = "irn", ht = "error", de$1 = "wss://relay.walletconnect.com", ge$1 = "wss://relay.walletconnect.org", ct = "relayer", D$1 = { message: "relayer_message", message_ack: "relayer_message_ack", connect: "relayer_connect", disconnect: "relayer_disconnect", error: "relayer_error", connection_stalled: "relayer_connection_stalled", transport_closed: "relayer_transport_closed", publish: "relayer_publish" }, ut = "_subscription", T = { payload: "payload", connect: "connect", disconnect: "disconnect", error: "error" }, lt = cjs$2.ONE_SECOND, dt = "2.10.2", gt = 1e4, pt = "0.3", Dt = "WALLETCONNECT_CLIENT_ID", w = { created: "subscription_created", deleted: "subscription_deleted", expired: "subscription_expired", disabled: "subscription_disabled", sync: "subscription_sync", resubscribed: "subscription_resubscribed" }, yt = "subscription", mt = "0.3", bt = cjs$2.FIVE_SECONDS * 1e3, ft$1 = "pairing", Et = "0.3", F$1 = { wc_pairingDelete: { req: { ttl: cjs$2.ONE_DAY, prompt: false, tag: 1e3 }, res: { ttl: cjs$2.ONE_DAY, prompt: false, tag: 1001 } }, wc_pairingPing: { req: { ttl: cjs$2.THIRTY_SECONDS, prompt: false, tag: 1002 }, res: { ttl: cjs$2.THIRTY_SECONDS, prompt: false, tag: 1003 } }, unregistered_method: { req: { ttl: cjs$2.ONE_DAY, prompt: false, tag: 0 }, res: { ttl: cjs$2.ONE_DAY, prompt: false, tag: 0 } } }, B = { create: "pairing_create", expire: "pairing_expire", delete: "pairing_delete", ping: "pairing_ping" }, R = { created: "history_created", updated: "history_updated", deleted: "history_deleted", sync: "history_sync" }, wt = "history", vt = "0.3", It = "expirer", v$1 = { created: "expirer_created", deleted: "expirer_deleted", expired: "expirer_expired", sync: "expirer_sync" }, Ct$1 = "0.3", Q$2 = "verify-api", Z = "https://verify.walletconnect.com", pe$1 = "https://verify.walletconnect.org";
class Rt {
  constructor(e, t) {
...
class _t {
  constructor(e, t, i) {
    this.core = e, this.logger = t, this.name = Ze, this.initialized = false, this.init = async () => {
      ...
      this.isInitialized();
      const n2 = await this.getClientSeed(), a2 = generateKeyPair(n2), o = Dn(), h2 = et;
      return await signJWT(o, s, h2, a2);
    }, this.generateSharedKey = (s, n2, a2) => {
      this.isInitialized();
      const o = this.getPrivateKey(s), h2 = kn(o, n2);
      ...
      this.isInitialized();
      const o = Re(a2), h2 = safeJsonStringify(n2);
      if (Fn(o)) {
        const y2 = o.senderPublicKey, $2 = o.receiverPublicKey;
        s = await this.generateSharedKey(y2, $2);
      }
      const u2 = this.getSymKey(s), { type: d2, senderPublicKey: p2 } = o;
      return Kn({ type: d2, symKey: u2, message: h2, senderPublicKey: p2 });
    }, this.decode = async (s, n2, a2) => {
      this.isInitialized();
      const o = xn(n2, a2);
      if (Fn(o)) {
        const h2 = o.receiverPublicKey, u2 = o.senderPublicKey;
        s = await this.generateSharedKey(h2, u2);
      }
      try {
        const h2 = this.getSymKey(s), u2 = Ln({ symKey: h2, encoded: n2 });
    ...
    }, this.core = e, this.logger = cjs.generateChildLogger(t, this.name), this.keychain = i || new Rt(this.core, this.logger);
  }
  get context() {
    return cjs.getLoggerContext(this.logger);
  }
...
class Dr extends u$1 {
  constructor(e, t) {
    super(e, t), this.relayer = e, this.logger = t, this.events = new events.exports.EventEmitter(), this.name = at, this.queue = /* @__PURE__ */ new Map(), this.publishTimeout = cjs$2.toMiliseconds(cjs$2.TEN_SECONDS), this.needsTransportRestart = false, this.publish = async (i, s, n2) => {
      var a2;
      this.logger.debug("Publishing Payload"), this.logger.trace({ type: "method", method: "publish", params: { topic: i, message: s, opts: n2 } });
      try {
        const o = n2?.ttl || nt, h2 = mt$1(n2), u2 = n2?.prompt || false, d2 = n2?.tag || 0, p2 = n2?.id || getBigIntRpcId().toString(), y2 = { topic: i, message: s, opts: { ttl: o, relay: h2, prompt: u2, tag: d2, id: p2 } }, $2 = setTimeout(() => this.queue.set(p2, y2), this.publishTimeout);
        try {
          await await it$1(this.rpcPublish(i, s, o, h2, u2, d2, p2), this.publishTimeout, "Failed to publish payload, please try again."), this.removeRequestFromQueue(p2), this.relayer.events.emit(D$1.publish, y2);
        } catch (c2) {
          if (this.logger.debug("Publishing Payload stalled"), this.needsTransportRestart = true, (a2 = n2?.internal) != null && a2.throwOnFailedPublish)
            throw this.removeRequestFromQueue(p2), c2;
          return;
        } finally {
          clearTimeout($2);
        }
  ...
  rpcPublish(e, t, i, s, n2, a2, o) {
    var h2, u2, d2, p2;
    const y2 = { method: yt$1(s.protocol).publish, params: { topic: e, message: t, ttl: i, prompt: n2, tag: a2 }, id: o };
    return w$1((h2 = y2.params) == null ? void 0 : h2.prompt) && ((u2 = y2.params) == null || delete u2.prompt), w$1((d2 = y2.params) == null ? void 0 : d2.tag) && ((p2 = y2.params) == null || delete p2.tag), this.logger.debug("Outgoing Relay Payload"), this.logger.trace({ type: "message", direction: "outgoing", request: y2 }), this.relayer.request(y2);
  }
...
class xt extends d {
  constructor(e, t) {
    super(e, t), this.relayer = e, this.logger = t, this.subscriptions = /* @__PURE__ */ new Map(), this.topicMap = new yr(), this.events = new events.exports.EventEmitter(), this.name = yt, this.version = mt, this.pending = /* @__PURE__ */ new Map(), this.cached = [], this.initialized = false, this.pendingSubscriptionWatchLabel = "pending_sub_watch_label", this.pollingInterval = 20, this.storagePrefix = O$1, this.subscribeTimeout = 1e4, this.restartInProgress = false, this.batchSubscribeTopicsLimit = 500, this.init = async () => {
...
class zt extends g$3 {
  constructor(e) {
    super(e), this.protocol = "wc", this.version = 2, this.events = new events.exports.EventEmitter(), this.name = ct, this.transportExplicitlyClosed = false, this.initialized = false, this.connectionAttemptInProgress = false, this.connectionStatusPollingInterval = 20, this.staleConnectionErrors = ["socket hang up", "socket stalled"], this.hasExperiencedNetworkDisruption = false, this.request = async (t) => {
    ...
    }, this.core = e.core, this.logger = typeof e.logger < "u" && typeof e.logger != "string" ? cjs.generateChildLogger(e.logger, this.name) : cjs.pino(cjs.getDefaultLoggerOptions({ level: e.logger || ht })), this.messages = new St(this.logger, e.core), this.subscriber = new xt(this, this.logger), this.publisher = new Dr(this, this.logger), this.relayUrl = e?.relayUrl || de$1, this.projectId = e.projectId, this.provider = {};
  }
  async init() {
...
class Ft extends p$1 {
  constructor(e, t, i, s = O$1, n2 = void 0) {
    ...
    }, this.get = (a2) => (this.isInitialized(), this.logger.debug("Getting value"), this.logger.trace({ type: "method", method: "get", key: a2 }), this.getData(a2)), this.getAll = (a2) => (this.isInitialized(), a2 ? this.values.filter((o) => Object.keys(a2).every((h2) => ki(o[h2], a2[h2]))) : this.values), this.update = async (a2, o) => {
      this.isInitialized(), this.logger.debug("Updating value"), this.logger.trace({ type: "method", method: "update", key: a2, update: o });
      const h2 = Ut(Ut({}, this.getData(a2)), o);
...
class $t {
  constructor(e, t) {
    this.core = e, this.logger = t, this.name = ft$1, this.version = Et, this.events = new events.exports(), this.initialized = false, this.storagePrefix = O$1, this.ignoredPayloadTypes = [_$2], this.registeredMethods = [], this.init = async () => {
      this.initialized || (await this.pairings.init(), await this.cleanup(), this.registerRelayerEvents(), this.registerExpirerEvents(), this.initialized = true, this.logger.trace("Initialized"));
    }, this.register = ({ methods: i }) => {
      this.isInitialized(), this.registeredMethods = [.../* @__PURE__ */ new Set([...this.registeredMethods, ...i])];
    }, this.create = async () => {
      this.isInitialized();
      const i = Dn(), s = await this.core.crypto.setSymKey(i), n2 = lt$1(cjs$2.FIVE_MINUTES), a2 = { protocol: ot }, o = { topic: s, expiry: n2, relay: a2, active: false }, h2 = Nt$1({ protocol: this.core.protocol, version: this.core.version, topic: s, symKey: i, relay: a2 });
      ...
      const h2 = lt$1(cjs$2.FIVE_MINUTES), u2 = { topic: s, relay: a2, expiry: h2, active: false };
      return await this.pairings.set(s, u2), this.core.expirer.set(s, h2), i.activatePairing && await this.activate({ topic: s }), this.events.emit(B.create, u2), u2;
    }, this.activate = async ({ topic: i }) => {
      this.isInitialized();
      const s = lt$1(cjs$2.THIRTY_DAYS);
      await this.pairings.update(i, { active: true, expiry: s }), this.core.expirer.set(i, s);
    }, this.ping = async (i) => {
      this.isInitialized(), await this.isValidPing(i);
      const { topic: s } = i;
      if (this.pairings.keys.includes(s)) {
        const n2 = await this.sendRequest(s, "wc_pairingPing", {}), { done: a2, resolve: o, reject: h2 } = st$1();
        this.events.once(ft$2("pairing_ping", n2), ({ error: u2 }) => {
          u2 ? h2(u2) : o();
        }), await a2();
      }
      ...
      const a2 = formatJsonRpcRequest(s, n2), o = await this.core.crypto.encode(i, a2), h2 = F$1[s].req;
      return this.core.history.set(i, a2), this.core.relayer.publish(i, o, h2), a2.id;
    }, this.sendResult = async (i, s, n2) => {
      const a2 = formatJsonRpcResult(i, n2), o = await this.core.crypto.encode(s, a2), h2 = await this.core.history.get(s, i), u2 = F$1[h2.request.method].res;
      await this.core.relayer.publish(s, o, u2), await this.core.history.resolve(a2);
    }, this.sendError = async (i, s, n2) => {
      const a2 = formatJsonRpcError(i, n2), o = await this.core.crypto.encode(s, a2), h2 = await this.core.history.get(s, i), u2 = F$1[h2.request.method] ? F$1[h2.request.method].res : F$1.unregistered_method.res;
      await this.core.relayer.publish(s, o, u2), await this.core.history.resolve(a2);
    ...
    }, this.core = e, this.logger = cjs.generateChildLogger(t, this.name), this.pairings = new Ft(this.core, this.logger, this.name, this.storagePrefix);
  }
  get context() {
    return cjs.getLoggerContext(this.logger);
  }
...
class Mt extends h {
  constructor(e, t) {
    super(e, t), this.core = e, this.logger = t, this.records = /* @__PURE__ */ new Map(), this.events = new events.exports.EventEmitter(), this.name = wt, this.version = vt, this.cached = [], this.initialized = false, this.storagePrefix = O$1, this.init = async () => {
      ...
      if (this.isInitialized(), this.logger.debug("Setting JSON-RPC request history record"), this.logger.trace({ type: "method", method: "set", topic: i, request: s, chainId: n2 }), this.records.has(s.id))
        return;
      const a2 = { id: s.id, topic: i, request: { method: s.method, params: s.params || null }, chainId: n2, expiry: lt$1(cjs$2.THIRTY_DAYS) };
...
class kt extends E$1 {
  constructor(e, t) {
    super(e, t), this.core = e, this.logger = t, this.expirations = /* @__PURE__ */ new Map(), this.events = new events.exports.EventEmitter(), this.name = It, this.version = Ct$1, this.cached = [], this.initialized = false, this.storagePrefix = O$1, this.init = async () => {
...
class Kt extends y$1 {
  constructor(e, t) {
    super(e, t), this.projectId = e, this.logger = t, this.name = Q$2, this.initialized = false, this.queue = [], this.verifyDisabled = false, this.init = async () => {
      ...
      const n2 = this.startAbortTimer(cjs$2.ONE_SECOND * 2), a2 = await fetch(`${s}/attestation/${i}`, { signal: this.abortController.signal });
      ...
      }, cjs$2.toMiliseconds(cjs$2.FIVE_SECONDS)))]);
    }, this.removeIframe = () => {
      this.iframe && (this.iframe.remove(), this.iframe = void 0, this.initialized = false);
    }, this.logger = cjs.generateChildLogger(t, this.name), this.verifyUrl = Z, this.abortController = new AbortController(), this.isDevEnv = te() && {}.IS_VITEST;
  }
  get context() {
    return cjs.getLoggerContext(this.logger);
  }
  startAbortTimer(e) {
    return this.abortController = new AbortController(), setTimeout(() => this.abortController.abort(), cjs$2.toMiliseconds(e));
  }
}
...
class ee extends n {
  constructor(e) {
    super(e), this.protocol = ue, this.version = We, this.name = X$1, this.events = new events.exports.EventEmitter(), this.initialized = false, this.on = (i, s) => this.events.on(i, s), this.once = (i, s) => this.events.once(i, s), this.off = (i, s) => this.events.off(i, s), this.removeListener = (i, s) => this.events.removeListener(i, s), this.projectId = e?.projectId, this.relayUrl = e?.relayUrl || de$1, this.customStoragePrefix = e != null && e.customStoragePrefix ? `:${e.customStoragePrefix}` : "";
    const t = typeof e?.logger < "u" && typeof e?.logger != "string" ? e.logger : cjs.pino(cjs.getDefaultLoggerOptions({ level: e?.logger || Xe.logger }));
    this.logger = cjs.generateChildLogger(t, this.name), this.heartbeat = new cjs$1.HeartBeat(), this.crypto = new _t(this, this.logger, e?.keychain), this.history = new Mt(this, this.logger), this.expirer = new kt(this, this.logger), this.storage = e != null && e.storage ? e.storage : new h$1(qt(qt({}, Qe), e?.storageOptions)), this.relayer = new zt({ core: this, logger: this.logger, relayUrl: this.relayUrl, projectId: this.projectId }), this.pairing = new $t(this, this.logger), this.verify = new Kt(this.projectId || "", this.logger);
  }
  static async init(e) {
    const t = new ee(e);
    await t.initialize();
...
class ps extends S$1 {
  constructor(r) {
    super(r), this.name = ce, this.events = new events.exports(), this.initialized = false, this.ignoredPayloadTypes = [_$2], this.requestQueue = { state: I.idle, queue: [] }, this.sessionRequestQueue = { state: I.idle, queue: [] }, this.requestQueueDelay = cjs$2.ONE_SECOND, this.init = async () => {
      ...
      const s = b(g$1({}, e), { requiredNamespaces: e.requiredNamespaces || {}, optionalNamespaces: e.optionalNamespaces || {} });
      await this.isValidConnect(s);
      const { pairingTopic: t, requiredNamespaces: i, optionalNamespaces: n2, sessionProperties: o, relays: a2 } = s;
      let c2 = t, p2, d2 = false;
      ...
      const h2 = await this.client.core.crypto.generateKeyPair(), R2 = g$1({ requiredNamespaces: i, optionalNamespaces: n2, relays: a2 ?? [{ protocol: ot }], proposer: { publicKey: h2, metadata: this.client.metadata } }, o && { sessionProperties: o }), { reject: w2, resolve: T2, done: K2 } = st$1(cjs$2.FIVE_MINUTES, oe);
      if (this.events.once(ft$2("session_connect"), async ({ error: v2, session: S2 }) => {
        if (v2)
          w2(v2);
        else if (S2) {
          S2.self.publicKey = h2;
          const B2 = b(g$1({}, S2), { requiredNamespaces: S2.requiredNamespaces, optionalNamespaces: S2.optionalNamespaces });
      ...
      const L2 = await this.sendRequest({ topic: c2, method: "wc_sessionPropose", params: R2 }), ue2 = lt$1(cjs$2.FIVE_MINUTES);
      ...
      let { pairingTopic: a2, proposer: c2, requiredNamespaces: p2, optionalNamespaces: d2 } = o;
      a2 = a2 || "", B$1(p2) || (p2 = At$1(i, "approve()"));
      const h2 = await this.client.core.crypto.generateKeyPair(), R2 = c2.publicKey, w2 = await this.client.core.crypto.generateSharedKey(h2, R2);
      a2 && s && (await this.client.core.pairing.updateMetadata({ topic: a2, metadata: c2.metadata }), await this.sendResult({ id: s, topic: a2, result: { relay: { protocol: t ?? "irn" }, responderPublicKey: h2 } }), await this.client.proposal.delete(s, U$2("USER_DISCONNECTED")), await this.client.core.pairing.activate({ topic: a2 }));
      const T2 = g$1({ relay: { protocol: t ?? "irn" }, namespaces: i, requiredNamespaces: p2, optionalNamespaces: d2, pairingTopic: a2, controller: { publicKey: h2, metadata: this.client.metadata }, expiry: lt$1(A) }, n2 && { sessionProperties: n2 });
      ...
      const K2 = b(g$1({}, T2), { topic: w2, pairingTopic: a2, acknowledged: false, self: T2.controller, peer: { publicKey: c2.publicKey, metadata: c2.metadata }, controller: h2 });
      return await this.client.session.set(w2, K2), await this.setExpiry(w2, lt$1(A)), { topic: w2, acknowledged: () => new Promise((L2) => setTimeout(() => L2(this.client.session.get(w2)), 500)) };
    }, this.reject = async (e) => {
      ...
      const { chainId: s, request: t, topic: i, expiry: n2 } = e, o = payloadId(), { done: a2, resolve: c2, reject: p2 } = st$1(n2, "Request expired. Please try again.");
      return this.events.once(ft$2("session_request", o), ({ error: d2, result: h2 }) => {
        d2 ? p2(d2) : c2(h2);
      }), await Promise.all([new Promise(async (d2) => {
        await this.sendRequest({ clientRpcId: o, topic: i, method: "wc_sessionRequest", params: { request: t, chainId: s }, expiry: n2, throwOnFailedPublish: true }).catch((h2) => p2(h2)), this.client.events.emit("session_request_sent", { topic: i, request: t, chainId: s, id: o }), d2();
      }), new Promise(async (d2) => {
        const h2 = await this.client.core.storage.getItem(W);
        pt$1({ id: o, topic: i, wcDeepLink: h2 }), d2();
      }), a2()]).then((d2) => d2[2]);
      ...
      const { topic: s, method: t, params: i, expiry: n2, relayRpcId: o, clientRpcId: a2, throwOnFailedPublish: c2 } = e, p2 = formatJsonRpcRequest(t, i, a2);
      if (q$1() && pe.includes(t)) {
        const R2 = Mn(JSON.stringify(p2));
        this.client.core.verify.register({ attestationId: R2 });
      }
      const d2 = await this.client.core.crypto.encode(s, p2), h2 = V[t].req;
      return n2 && (h2.ttl = n2), o && (h2.id = o), this.client.core.history.set(s, p2), c2 ? (h2.internal = b(g$1({}, h2.internal), { throwOnFailedPublish: true }), await this.client.core.relayer.publish(s, d2, h2)) : this.client.core.relayer.publish(s, d2, h2).catch((R2) => this.client.logger.error(R2)), p2.id;
    }, this.sendResult = async (e) => {
      const { id: s, topic: t, result: i, throwOnFailedPublish: n2 } = e, o = formatJsonRpcResult(s, i), a2 = await this.client.core.crypto.encode(t, o), c2 = await this.client.core.history.get(t, s), p2 = V[c2.request.method].res;
      n2 ? (p2.internal = b(g$1({}, p2.internal), { throwOnFailedPublish: true }), await this.client.core.relayer.publish(t, a2, p2)) : this.client.core.relayer.publish(t, a2, p2).catch((d2) => this.client.logger.error(d2)), await this.client.core.history.resolve(o);
      ...
      try {
        ...
        const n2 = lt$1(cjs$2.FIVE_MINUTES), o = g$1({ id: i, pairingTopic: e, expiry: n2 }, t);
      ...
      try {
        ...
        const { relay: n2, controller: o, expiry: a2, namespaces: c2, requiredNamespaces: p2, optionalNamespaces: d2, sessionProperties: h2, pairingTopic: R2 } = s.params, w2 = g$1({ topic: e, relay: n2, expiry: a2, namespaces: c2, acknowledged: true, pairingTopic: R2, requiredNamespaces: p2, optionalNamespaces: d2, controller: o.publicKey, self: { publicKey: "", metadata: this.client.metadata }, peer: { publicKey: o.publicKey, metadata: o.metadata } }, h2 && { sessionProperties: h2 });
      ...
      if (!h$2(i, true)) {
        const { message: p2 } = N$2("MISSING_OR_INVALID", `approve() relayProtocol: ${i}`);
        throw new Error(p2);
      }
...
class Q$1 extends b$1 {
  constructor(r) {
    super(r), this.protocol = X, this.version = F, this.name = M$1.name, this.events = new events.exports.EventEmitter(), this.on = (s, t) => this.events.on(s, t), this.once = (s, t) => this.events.once(s, t), this.off = (s, t) => this.events.off(s, t), this.removeListener = (s, t) => this.events.removeListener(s, t), this.removeAllListeners = (s) => this.events.removeAllListeners(s), this.connect = async (s) => {
      try {
    ...
    }, this.name = r?.name || M$1.name, this.metadata = r?.metadata || zn();
    const e = typeof r?.logger < "u" && typeof r?.logger != "string" ? r.logger : cjs.pino(cjs.getDefaultLoggerOptions({ level: r?.logger || M$1.logger }));
    this.core = r?.core || new Ar(r), this.logger = cjs.generateChildLogger(e, this.name), this.session = new ds(this.core, this.logger), this.proposal = new hs(this.core, this.logger), this.pendingRequest = new us(this.core, this.logger), this.engine = new ps(this);
  }
  static async init(r) {
    const e = new Q$1(r);
...
(function(C, u2) {
  (function() {
    ...
    function mn(h2, g2) {
      for (var p2 = -1, A2 = h2 == null ? 0 : h2.length; ++p2 < A2 && g2(h2[p2], p2, h2) !== false; )
        ;
      return h2;
    }
    function ko(h2, g2) {
    ...
    function As2(h2, g2) {
      for (var p2 = -1, A2 = h2 == null ? 0 : h2.length; ++p2 < A2; )
        if (!g2(h2[p2], p2, h2))
          return false;
      return true;
    }
    function jn2(h2, g2) {
      for (var p2 = -1, A2 = h2 == null ? 0 : h2.length, S2 = 0, U2 = []; ++p2 < A2; ) {
        var X2 = h2[p2];
    ...
    function Dr2(h2, g2, p2) {
      for (var A2 = -1, S2 = h2 == null ? 0 : h2.length; ++A2 < S2; )
        if (p2(g2, h2[A2]))
          return true;
      return false;
    }
    function G2(h2, g2) {
      for (var p2 = -1, A2 = h2 == null ? 0 : h2.length, S2 = Array(A2); ++p2 < A2; )
        S2[p2] = g2(h2[p2], p2, h2);
      return S2;
    }
    function nt2(h2, g2) {
      for (var p2 = -1, A2 = g2.length, S2 = h2.length; ++p2 < A2; )
        h2[S2 + p2] = g2[p2];
      return h2;
    }
    function Hr(h2, g2, p2, A2) {
      var S2 = -1, U2 = h2 == null ? 0 : h2.length;
      for (A2 && U2 && (p2 = h2[++S2]); ++S2 < U2; )
        p2 = g2(p2, h2[S2], S2, h2);
      return p2;
    }
    function jo(h2, g2, p2, A2) {
      var S2 = h2 == null ? 0 : h2.length;
      for (A2 && S2 && (p2 = h2[--S2]); S2--; )
        p2 = g2(p2, h2[S2], S2, h2);
      return p2;
    }
    function Nr(h2, g2) {
    ...
    function ye(h2, g2, p2, A2) {
      for (var S2 = h2.length, U2 = p2 + (A2 ? 1 : -1); A2 ? U2-- : ++U2 < S2; )
        if (g2(h2[U2], U2, h2))
          return U2;
      return -1;
    }
    function Tt2(h2, g2, p2) {
      return g2 === g2 ? gf(h2, g2, p2) : ye(h2, Is2, p2);
    }
    function rf(h2, g2, p2, A2) {
      for (var S2 = p2 - 1, U2 = h2.length; ++S2 < U2; )
        if (A2(h2[S2], g2))
          return S2;
      return -1;
    }
    ...
    function Es2(h2, g2, p2, A2, S2) {
      return S2(h2, function(U2, X2, M2) {
        p2 = A2 ? (A2 = false, U2) : g2(p2, U2, X2, M2);
      }), p2;
    }
    function sf(h2, g2) {
      var p2 = h2.length;
    ...
    function Wr(h2, g2) {
      for (var p2, A2 = -1, S2 = h2.length; ++A2 < S2; ) {
        var U2 = g2(h2[A2]);
        U2 !== i && (p2 = p2 === i ? U2 : p2 + U2);
      }
      return p2;
    }
    function Fr(h2, g2) {
      for (var p2 = -1, A2 = Array(h2); ++p2 < h2; )
        A2[p2] = g2(p2);
      return A2;
    }
    function uf(h2, g2) {
    ...
    function Ss2(h2, g2) {
      for (var p2 = -1, A2 = h2.length; ++p2 < A2 && Tt2(g2, h2[p2], 0) > -1; )
        ;
      return p2;
    }
    function Os2(h2, g2) {
    ...
    function pf(h2) {
      for (var g2, p2 = []; !(g2 = h2.next()).done; )
        p2.push(g2.value);
      return p2;
    }
    function qr(h2) {
      var g2 = -1, p2 = Array(h2.size);
      return h2.forEach(function(A2, S2) {
        p2[++g2] = [S2, A2];
      }), p2;
    }
    function Rs2(h2, g2) {
    ...
    function tt2(h2, g2) {
      for (var p2 = -1, A2 = h2.length, S2 = 0, U2 = []; ++p2 < A2; ) {
        var X2 = h2[p2];
    ...
    function gf(h2, g2, p2) {
      for (var A2 = p2 - 1, S2 = h2.length; ++A2 < S2; )
        if (h2[A2] === g2)
          return A2;
      return -1;
    }
    function vf(h2, g2, p2) {
      for (var A2 = p2 + 1; A2--; )
        if (h2[A2] === g2)
          return A2;
      return A2;
    ...
    function bs2(h2) {
      for (var g2 = h2.length; g2-- && so.test(h2.charAt(g2)); )
        ;
      return g2;
    }
    var _f = Ur(Yo);
    function mf(h2) {
      for (var g2 = br2.lastIndex = 0; br2.test(h2); )
        ++g2;
      return g2;
    }
    function wf(h2) {
    ...
    var Af = function h2(g2) {
      g2 = g2 == null ? k2 : Ht2.defaults(k2.Object(), g2, Ht2.pick(k2, Bo));
      var p2 = g2.Array, A2 = g2.Date, S2 = g2.Error, U2 = g2.Function, X2 = g2.Math, M2 = g2.Object, Br = g2.RegExp, Cf = g2.String, wn = g2.TypeError, Oe = p2.prototype, If = U2.prototype, Nt2 = M2.prototype, Re2 = g2["__core-js_shared__"], be = If.toString, F2 = Nt2.hasOwnProperty, xf = 0, Ts2 = function() {
        var n2 = /[^.]+$/.exec(Re2 && Re2.keys && Re2.keys.IE_PROTO || "");
        return n2 ? "Symbol(src)_1." + n2 : "";
      }(), Te = Nt2.toString, Ef = be.call(M2), yf = k2._, Sf = Br("^" + be.call(F2).replace(xr2, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), Le2 = ds2 ? g2.Buffer : i, et2 = g2.Symbol, De2 = g2.Uint8Array, Ls2 = Le2 ? Le2.allocUnsafe : i, He2 = Rs2(M2.getPrototypeOf, M2), Ds2 = M2.create, Hs2 = Nt2.propertyIsEnumerable, Ne2 = Oe.splice, Ns2 = et2 ? et2.isConcatSpreadable : i, ne2 = et2 ? et2.iterator : i, pt2 = et2 ? et2.toStringTag : i, $e2 = function() {
        try {
          var n2 = mt2(M2, "defineProperty");
          return n2({}, "", {}), n2;
        } catch {
        }
      }(), Of = g2.clearTimeout !== k2.clearTimeout && g2.clearTimeout, Rf = A2 && A2.now !== k2.Date.now && A2.now, bf = g2.setTimeout !== k2.setTimeout && g2.setTimeout, Ue2 = X2.ceil, We2 = X2.floor, Gr = M2.getOwnPropertySymbols, Tf = Le2 ? Le2.isBuffer : i, $s2 = g2.isFinite, Lf = Oe.join, Df = Rs2(M2.keys, M2), Q2 = X2.max, nn = X2.min, Hf = A2.now, Nf = g2.parseInt, Us2 = X2.random, $f = Oe.reverse, zr = mt2(g2, "DataView"), te2 = mt2(g2, "Map"), Kr = mt2(g2, "Promise"), $t2 = mt2(g2, "Set"), ee2 = mt2(g2, "WeakMap"), re = mt2(M2, "create"), Fe2 = ee2 && new ee2(), Ut2 = {}, Uf = wt2(zr), Wf = wt2(te2), Ff = wt2(Kr), Mf = wt2($t2), qf = wt2(ee2), Me2 = et2 ? et2.prototype : i, ie = Me2 ? Me2.valueOf : i, Ws2 = Me2 ? Me2.toString : i;
      function a2(n2) {
      ...
      function zf() {
        var n2 = this.__wrapped__.value(), t = this.__dir__, e = O2(n2), r = t < 0, s = e ? n2.length : 0, o = eh(0, s, this.__views__), f2 = o.start, c2 = o.end, l2 = c2 - f2, v2 = r ? c2 : f2 - 1, _2 = this.__iteratees__, m2 = _2.length, P2 = 0, I2 = nn(l2, this.__takeCount__);
        if (!e || !r && s == l2 && I2 == l2)
      ...
      function Zr(n2, t) {
        for (var e = -1, r = t.length, s = p2(r), o = n2 == null; ++e < r; )
          s[e] = o ? i : Si(n2, t[e]);
        return s;
      }
      function vt2(n2, t, e) {
      ...
      function An(n2, t, e, r, s, o) {
        ...
        if (I2)
          return I2;
        o.set(n2, f2), sa(n2) ? n2.forEach(function(y2) {
          f2.add(An(y2, t, e, y2, n2, o));
        }) : ra(n2) && n2.forEach(function(y2, D2) {
          f2.set(D2, An(y2, t, e, D2, n2, o));
        });
        var E2 = v2 ? l2 ? pi : li : l2 ? on : V2, b2 = _2 ? i : E2(n2);
        return mn(b2 || n2, function(y2, D2) {
          b2 && (D2 = y2, y2 = n2[D2]), se(f2, D2, An(y2, t, e, D2, n2, o));
        }), f2;
      }
      function _c(n2) {
        var t = V2(n2);
      ...
      function Vr(n2, t, e) {
        for (var r = e ? Dr2 : Ee, s = n2[0].length, o = n2.length, f2 = o, c2 = p2(o), l2 = 1 / 0, v2 = []; f2--; ) {
          var _2 = n2[f2];
          f2 && t && (_2 = G2(_2, hn(t))), l2 = nn(_2.length, l2), c2[f2] = !e && (t || s >= 120 && _2.length >= 120) ? new gt2(f2 && _2) : i;
        }
        _2 = n2[0];
        var m2 = -1, P2 = c2[0];
        n:
          for (; ++m2 < s && v2.length < l2; ) {
            var I2 = _2[m2], E2 = t ? t(I2) : I2;
            if (I2 = e || I2 !== 0 ? I2 : 0, !(P2 ? jt2(P2, E2) : r(v2, E2, e))) {
              for (f2 = o; --f2; ) {
                var b2 = c2[f2];
                if (!(b2 ? jt2(b2, E2) : r(n2[f2], E2, e)))
                  continue n;
              }
      ...
      function yc(n2, t, e, r, s, o) {
        ...
        if (!(e & Et2)) {
          var I2 = _2 && F2.call(n2, "__wrapped__"), E2 = m2 && F2.call(t, "__wrapped__");
          if (I2 || E2) {
            var b2 = I2 ? n2.value() : n2, y2 = E2 ? t.value() : t;
      ...
      function kr(n2, t, e, r) {
        ...
        for (; ++s < o; ) {
          ...
          if (f2 && c2[2]) {
            ...
            var m2 = new Rn2();
            if (r)
              var P2 = r(v2, _2, l2, n2, t, m2);
            if (!(P2 === i ? oe2(_2, v2, Et2 | ve2, r, m2) : P2))
              return false;
          }
        }
        return true;
      ...
      function Lc(n2, t, e, r, s, o, f2) {
        ...
        var _2 = o ? o(c2, l2, e + "", n2, t, f2) : i, m2 = _2 === i;
        if (m2) {
          var P2 = O2(l2), I2 = !P2 && at2(l2), E2 = !P2 && !I2 && Bt2(l2);
          _2 = l2, P2 || I2 || E2 ? O2(c2) ? _2 = c2 : Z2(c2) ? _2 = un2(c2) : I2 ? (m2 = false, _2 = hu(l2, true)) : E2 ? (m2 = false, _2 = lu(l2, true)) : _2 = [] : pe2(l2) || Pt2(l2) ? (_2 = c2, Pt2(c2) ? _2 = oa(c2) : (!K2(c2) || Jn2(c2)) && (_2 = bu(l2))) : m2 = false;
        }
        m2 && (f2.set(l2, _2), s(_2, l2, r, o, f2), f2.delete(l2)), Yr(n2, e, _2);
      }
      function nu(n2, t) {
        var e = n2.length;
        if (e)
      ...
      function ti(n2, t, e, r) {
        ...
        for (n2 === t && (t = un2(t)), e && (c2 = G2(n2, hn(e))); ++o < f2; )
          for (var l2 = 0, v2 = t[o], _2 = e ? e(v2) : v2; (l2 = s(c2, _2, l2, r)) > -1; )
      ...
      function Nc(n2, t, e, r) {
        for (var s = -1, o = Q2(Ue2((t - n2) / (e || 1)), 0), f2 = p2(o); o--; )
          f2[r ? o : ++s] = n2, n2 += e;
        return f2;
      }
      function ri(n2, t) {
      ...
      function fe(n2, t, e, r) {
        ...
        for (var s = -1, o = t.length, f2 = o - 1, c2 = n2; c2 != null && ++s < o; ) {
          ...
          if (s != f2) {
            var _2 = c2[l2];
            v2 = r ? r(_2, l2, c2) : i, v2 === i && (v2 = K2(_2) ? _2 : Zn(t[s + 1]) ? [] : {});
          }
      ...
      function ii(n2, t, e, r) {
        ...
        for (var f2 = t !== t, c2 = t === null, l2 = pn(t), v2 = t === i; s < o; ) {
          var _2 = We2((s + o) / 2), m2 = e(n2[_2]), P2 = m2 !== i, I2 = m2 === null, E2 = m2 === m2, b2 = pn(m2);
          if (f2)
            var y2 = r || E2;
          else
            v2 ? y2 = E2 && (r || P2) : c2 ? y2 = E2 && P2 && (r || !I2) : l2 ? y2 = E2 && P2 && !I2 && (r || !b2) : I2 || b2 ? y2 = false : y2 = r ? m2 <= t : m2 < t;
          y2 ? s = _2 + 1 : o = _2;
        }
        return nn(o, Fa);
      }
        ...
        n:
          for (; ++r < o; ) {
            ...
            if (_2 = e || _2 !== 0 ? _2 : 0, f2 && m2 === m2) {
              ...
              s(l2, m2, e) || (l2 !== c2 && l2.push(m2), c2.push(_2));
          }
        return c2;
      }
      function si(n2, t) {
      ...
      function du(n2, t, e, r) {
        for (var s = -1, o = n2.length, f2 = e.length, c2 = -1, l2 = t.length, v2 = Q2(o - f2, 0), _2 = p2(l2 + v2), m2 = !r; ++c2 < l2; )
          _2[c2] = t[c2];
        for (; ++s < f2; )
          (m2 || s < o) && (_2[e[s]] = n2[s]);
        for (; v2--; )
      ...
      function gu(n2, t, e, r) {
        for (var s = -1, o = n2.length, f2 = -1, c2 = e.length, l2 = -1, v2 = t.length, _2 = Q2(o - c2, 0), m2 = p2(_2 + v2), P2 = !r; ++s < _2; )
          m2[s] = n2[s];
        for (var I2 = s; ++l2 < v2; )
          m2[I2 + l2] = t[l2];
        for (; ++f2 < c2; )
      ...
      function Xc(n2, t, e) {
        var r = ce2(n2);
        function s() {
          for (var o = arguments.length, f2 = p2(o), c2 = o, l2 = qt2(s); c2--; )
            f2[c2] = arguments[c2];
          var v2 = o < 3 && f2[0] !== l2 && f2[o - 1] !== l2 ? [] : tt2(f2, l2);
          if (o -= v2.length, o < e)
            return Iu(n2, t, Xe2, s.placeholder, i, f2, v2, i, i, e - o);
          var _2 = this && this !== k2 && this instanceof s ? r : n2;
      ...
      function Xe2(n2, t, e, r, s, o, f2, c2, l2, v2) {
        var _2 = t & Mn2, m2 = t & vn, P2 = t & ct2, I2 = t & (Dn2 | yt2), E2 = t & dr, b2 = P2 ? i : ce2(n2);
        function y2() {
          for (var D2 = arguments.length, N2 = p2(D2), dn = D2; dn--; )
            N2[dn] = arguments[dn];
          if (I2)
            var sn = qt2(y2), gn = af(N2, sn);
          if (r && (N2 = du(N2, r, s, I2)), o && (N2 = gu(N2, o, f2, I2)), D2 -= gn, I2 && D2 < v2) {
            var J = tt2(N2, sn);
            return Iu(n2, t, Xe2, y2.placeholder, e, N2, J, c2, l2, v2 - D2);
          }
          var Tn = m2 ? e : this, Qn = P2 ? Tn[n2] : n2;
          return D2 = N2.length, c2 ? N2 = gh(N2, c2) : E2 && D2 > 1 && N2.reverse(), _2 && l2 < D2 && (N2.length = l2), this && this !== k2 && this instanceof y2 && (Qn = b2 || ce2(Qn)), Qn.apply(Tn, N2);
        }
        return y2;
      }
      function Au(n2, t) {
      ...
      function Qc(n2, t, e, r) {
        var s = t & vn, o = ce2(n2);
        function f2() {
          for (var c2 = -1, l2 = arguments.length, v2 = -1, _2 = r.length, m2 = p2(_2 + l2), P2 = this && this !== k2 && this instanceof f2 ? o : n2; ++v2 < _2; )
            m2[v2] = r[v2];
          for (; l2--; )
            m2[v2++] = arguments[++c2];
      ...
      function Iu(n2, t, e, r, s, o, f2, c2, l2, v2) {
        var _2 = t & Dn2, m2 = _2 ? f2 : i, P2 = _2 ? i : f2, I2 = _2 ? o : i, E2 = _2 ? i : o;
        t |= _2 ? Hn : St2, t &= ~(_2 ? St2 : Hn), t & qi2 || (t &= ~(vn | ct2));
        var b2 = [n2, t, s, I2, m2, E2, P2, c2, l2, v2], y2 = e.apply(i, b2);
        return mi(n2) && Nu(y2, b2), y2.placeholder = r, $u(y2, n2, t);
      }
      function hi(n2) {
        var t = X2[n2];
        return function(e, r) {
      ...
      function Kn2(n2, t, e, r, s, o, f2, c2) {
        ...
        if (!l2 && typeof n2 != "function")
          throw new wn($2);
        var v2 = r ? r.length : 0;
        if (v2 || (t &= ~(Hn | St2), r = s = i), f2 = f2 === i ? f2 : Q2(R2(f2), 0), c2 = c2 === i ? c2 : R2(c2), v2 -= s ? s.length : 0, t & St2) {
          var _2 = r, m2 = s;
          r = s = i;
        }
        var P2 = l2 ? i : di(n2), I2 = [n2, t, e, r, s, _2, m2, o, f2, c2];
        if (P2 && lh(I2, P2), n2 = I2[0], t = I2[1], e = I2[2], r = I2[3], s = I2[4], c2 = I2[9] = I2[9] === i ? l2 ? 0 : n2.length : Q2(I2[9] - v2, 0), !c2 && t & (Dn2 | yt2) && (t &= ~(Dn2 | yt2)), !t || t == vn)
          var E2 = Jc(n2, t, e);
        else
          t == Dn2 || t == yt2 ? E2 = Xc(n2, t, c2) : (t == Hn || t == (vn | Hn)) && !s.length ? E2 = Qc(n2, t, e, r) : E2 = Xe2.apply(i, I2);
        var b2 = P2 ? iu : Nu;
        return $u(b2(E2, I2), n2, t);
      }
        ...
        for (o.set(n2, t), o.set(t, n2); ++m2 < c2; ) {
          ...
          if (I2) {
            if (!Nr(t, function(D2, N2) {
              if (!jt2(I2, N2) && (E2 === D2 || s(E2, D2, e, r, o)))
                return I2.push(N2);
            })) {
              P2 = false;
              break;
      ...
      function nh(n2, t, e, r, s, o) {
        var f2 = e & Et2, c2 = li(n2), l2 = c2.length, v2 = li(t), _2 = v2.length;
        if (l2 != _2 && !f2)
          return false;
        for (var m2 = l2; m2--; ) {
          var P2 = c2[m2];
        ...
        if (b2 && !y2) {
          ...
          sn != gn && "constructor" in n2 && "constructor" in t && !(typeof sn == "function" && sn instanceof sn && typeof gn == "function" && gn instanceof gn) && (b2 = false);
        }
...
`);
      ...
      function _h(n2, t, e) {
        (e ? rn(n2, t, e) : t === i) ? t = 1 : t = Q2(R2(t), 0);
        var r = n2 == null ? 0 : n2.length;
        if (!r || t < 1)
          return [];
        for (var s = 0, o = 0, f2 = p2(Ue2(r / t)); s < r; )
          f2[o++] = Cn(n2, s, s += t);
        return f2;
      }
      function mh(n2) {
      ...
      function wh() {
        ...
        if (!n2)
          return [];
        for (var t = p2(n2 - 1), e = arguments[0], r = n2; r--; )
          t[r - 1] = arguments[r];
      ...
      function Mu(n2, t, e) {
        ...
        if (!r)
          return -1;
        var s = e == null ? 0 : R2(e);
        return s < 0 && (s = Q2(r + s, 0)), ye(n2, x2(t, 3), s);
      }
      function qu(n2, t, e) {
        var r = n2 == null ? 0 : n2.length;
        if (!r)
          return -1;
        var s = r - 1;
        return e !== i && (s = R2(e), s = e < 0 ? Q2(r + s, 0) : nn(s, r - 1)), ye(n2, x2(t, 3), s, true);
      }
      function Bu(n2) {
      ...
      function Th(n2, t, e) {
        ...
        if (!r)
          return -1;
        var s = e == null ? 0 : R2(e);
        return s < 0 && (s = Q2(r + s, 0)), Tt2(n2, t, s);
      }
      function Lh(n2) {
        var t = n2 == null ? 0 : n2.length;
        return t ? Cn(n2, 0, -1) : [];
      ...
      function Uh(n2, t, e) {
        ...
        if (!r)
          return -1;
        var s = r;
        return e !== i && (s = R2(e), s = s < 0 ? Q2(r + s, 0) : nn(s, r - 1)), t === t ? vf(n2, t, s) : ye(n2, Is2, s, true);
      }
      function Wh(n2, t) {
      ...
      var Ul = L2(function(n2, t, e) {
        var r = -1, s = typeof t == "function", o = an2(n2) ? p2(n2.length) : [];
      ...
      function na(n2, t, e) {
        var r, s, o, f2, c2, l2, v2 = 0, _2 = false, m2 = false, P2 = true;
        if (typeof n2 != "function")
          throw new wn($2);
        t = xn2(t) || 0, K2(e) && (_2 = !!e.leading, m2 = "maxWait" in e, o = m2 ? Q2(xn2(e.maxWait) || 0, t) : o, P2 = "trailing" in e ? !!e.trailing : P2);
        function I2(J) {
          var Tn = r, Qn = s;
          return r = s = i, v2 = J, f2 = n2.apply(Qn, Tn), f2;
        }
        function E2(J) {
          return v2 = J, c2 = le2(D2, t), _2 ? I2(J) : f2;
        }
        function b2(J) {
      ...
      function ip(n2, t) {
        if (typeof n2 != "function")
          throw new wn($2);
        return t = t == null ? 0 : Q2(R2(t), 0), L2(function(e) {
      ...
      }, O2 = p2.isArray, vp = gs2 ? hn(gs2) : xc;
      function an2(n2) {
      ...
      var qp = L2(function(n2, t) {
        ...
        for (s && rn(t[0], t[1], s) && (r = 1); ++e < r; )
          for (var o = t[e], f2 = on(o), c2 = -1, l2 = f2.length; ++c2 < l2; ) {
            var v2 = f2[c2], _2 = n2[v2];
            (_2 === i || bn(_2, Nt2[v2]) && !F2.call(n2, v2)) && (n2[v2] = o[v2]);
          }
        return n2;
      }), Bp = L2(function(n2) {
      ...
      function Nd(n2, t, e) {
        ...
        var s = fr2({}, t.imports, r.imports, Eu), o = V2(s), f2 = Mr(s, o), c2, l2, v2 = 0, _2 = t.interpolate || Ce, m2 = "__p += '", P2 = Br((t.escape || Ce).source + "|" + _2.source + "|" + (_2 === Zi2 ? lo : Ce).source + "|" + (t.evaluate || Ce).source + "|$", "g"), I2 = "//# sourceURL=" + (F2.call(t, "sourceURL") ? (t.sourceURL + "").replace(/\s/g, " ") : "lodash.templateSources[" + ++Go + "]") + `
`;
        n2.replace(P2, function(y2, D2, N2, dn, sn, gn) {
...
`;
          ...
          throw new S2(En);
        m2 = (l2 ? m2.replace(Ja, "") : m2).replace(Xa, "$1").replace(Qa, "$1;"), m2 = "function(" + (E2 || "obj") + `) {
` + (E2 ? "" : `obj || (obj = {});
...
`) + m2 + `return __p
      ...
      function qd(n2, t) {
        ...
        if (f2 && (c2 += l2.length - c2), yi(s)) {
          if (n2.slice(c2).search(s)) {
            var v2, _2 = l2;
            for (s.global || (s = Br(s.source, W2(Ji2.exec(s)) + "g")), s.lastIndex = 0; v2 = s.exec(_2); )
              var m2 = v2.index;
      ...
      function Li(n2, t, e) {
        ...
        var o = !(K2(e) && "chain" in e) || !!e.chain, f2 = Jn2(n2);
        return mn(s, function(c2) {
          var l2 = t[c2];
          n2[c2] = l2, f2 && (n2.prototype[c2] = function() {
            var v2 = this.__chain__;
            if (o || v2) {
              var _2 = n2(this.__wrapped__), m2 = _2.__actions__ = un2(this.__actions__);
              return m2.push({ func: l2, args: arguments, thisArg: n2 }), _2.__chain__ = v2, _2;
            }
      ...
      return a2.after = Ql, a2.ary = Xu, a2.assign = Up, a2.assignIn = fa, a2.assignInWith = fr2, a2.assignWith = Wp, a2.at = Fp, a2.before = Qu, a2.bind = Ii, a2.bindAll = zd, a2.bindKey = Vu, a2.castArray = op, a2.chain = Yu, a2.chunk = _h, a2.compact = mh, a2.concat = wh, a2.cond = Kd, a2.conforms = Yd, a2.constant = bi, a2.countBy = Sl, a2.create = Mp, a2.curry = ku, a2.curryRight = ju, a2.debounce = na, a2.defaults = qp, a2.defaultsDeep = Bp, a2.defer = Vl, a2.delay = kl, a2.difference = Ph, a2.differenceBy = Ah, a2.differenceWith = Ch, a2.drop = Ih, a2.dropRight = xh, a2.dropRightWhile = Eh, a2.dropWhile = yh, a2.fill = Sh, a2.filter = Rl, a2.flatMap = Ll, a2.flatMapDeep = Dl, a2.flatMapDepth = Hl, a2.flatten = Bu, a2.flattenDeep = Oh, a2.flattenDepth = Rh, a2.flip = jl, a2.flow = Jd, a2.flowRight = Xd, a2.fromPairs = bh, a2.functions = Xp, a2.functionsIn = Qp, a2.groupBy = Nl, a2.initial = Lh, a2.intersection = Dh, a2.intersectionBy = Hh, a2.intersectionWith = Nh, a2.invert = kp, a2.invertBy = jp, a2.invokeMap = Ul, a2.iteratee = Ti, a2.keyBy = Wl, a2.keys = V2, a2.keysIn = on, a2.map = rr2, a2.mapKeys = td, a2.mapValues = ed, a2.matches = Qd, a2.matchesProperty = Vd, a2.memoize = sr2, a2.merge = rd, a2.mergeWith = ca, a2.method = kd, a2.methodOf = jd, a2.mixin = Li, a2.negate = ur2, a2.nthArg = tg, a2.omit = id, a2.omitBy = sd, a2.once = np, a2.orderBy = Fl, a2.over = eg, a2.overArgs = tp, a2.overEvery = rg, a2.overSome = ig, a2.partial = xi, a2.partialRight = ta, a2.partition = Ml, a2.pick = ud, a2.pickBy = ha, a2.property = ma, a2.propertyOf = sg, a2.pull = Fh, a2.pullAll = zu, a2.pullAllBy = Mh, a2.pullAllWith = qh, a2.pullAt = Bh, a2.range = ug, a2.rangeRight = ag, a2.rearg = ep, a2.reject = Gl, a2.remove = Gh, a2.rest = rp, a2.reverse = Ai, a2.sampleSize = Kl, a2.set = od, a2.setWith = fd, a2.shuffle = Yl, a2.slice = zh, a2.sortBy = Xl, a2.sortedUniq = Vh, a2.sortedUniqBy = kh, a2.split = Ld, a2.spread = ip, a2.tail = jh, a2.take = nl, a2.takeRight = tl, a2.takeRightWhile = el, a2.takeWhile = rl, a2.tap = ml, a2.throttle = sp, a2.thru = er2, a2.toArray = ua, a2.toPairs = la, a2.toPairsIn = pa, a2.toPath = lg, a2.toPlainObject = oa, a2.transform = cd, a2.unary = up, a2.union = il, a2.unionBy = sl, a2.unionWith = ul, a2.uniq = al, a2.uniqBy = ol, a2.uniqWith = fl, a2.unset = hd, a2.unzip = Ci, a2.unzipWith = Ku, a2.update = ld, a2.updateWith = pd, a2.values = Gt2, a2.valuesIn = dd, a2.without = cl, a2.words = va, a2.wrap = ap, a2.xor = hl, a2.xorBy = ll, a2.xorWith = pl, a2.zip = dl, a2.zipObject = gl, a2.zipObjectDeep = vl, a2.zipWith = _l, a2.entries = la, a2.entriesIn = pa, a2.extend = fa, a2.extendWith = fr2, Li(a2, a2), a2.add = dg, a2.attempt = _a, a2.camelCase = md, a2.capitalize = da, a2.ceil = gg, a2.clamp = gd, a2.clone = fp, a2.cloneDeep = hp, a2.cloneDeepWith = lp, a2.cloneWith = cp, a2.conformsTo = pp, a2.deburr = ga, a2.defaultTo = Zd, a2.divide = vg, a2.endsWith = wd, a2.eq = bn, a2.escape = Pd, a2.escapeRegExp = Ad, a2.every = Ol, a2.find = bl, a2.findIndex = Mu, a2.findKey = Gp, a2.findLast = Tl, a2.findLastIndex = qu, a2.findLastKey = zp, a2.floor = _g, a2.forEach = Zu, a2.forEachRight = Ju, a2.forIn = Kp, a2.forInRight = Yp, a2.forOwn = Zp, a2.forOwnRight = Jp, a2.get = Si, a2.gt = dp, a2.gte = gp, a2.has = Vp, a2.hasIn = Oi, a2.head = Gu, a2.identity = fn, a2.includes = $l, a2.indexOf = Th, a2.inRange = vd, a2.invoke = nd, a2.isArguments = Pt2, a2.isArray = O2, a2.isArrayBuffer = vp, a2.isArrayLike = an2, a2.isArrayLikeObject = Z2, a2.isBoolean = _p, a2.isBuffer = at2, a2.isDate = mp, a2.isElement = wp, a2.isEmpty = Pp, a2.isEqual = Ap, a2.isEqualWith = Cp, a2.isError = Ei, a2.isFinite = Ip, a2.isFunction = Jn2, a2.isInteger = ea, a2.isLength = ar2, a2.isMap = ra, a2.isMatch = xp, a2.isMatchWith = Ep, a2.isNaN = yp, a2.isNative = Sp, a2.isNil = Rp, a2.isNull = Op, a2.isNumber = ia, a2.isObject = K2, a2.isObjectLike = Y, a2.isPlainObject = pe2, a2.isRegExp = yi, a2.isSafeInteger = bp, a2.isSet = sa, a2.isString = or2, a2.isSymbol = pn, a2.isTypedArray = Bt2, a2.isUndefined = Tp, a2.isWeakMap = Lp, a2.isWeakSet = Dp, a2.join = $h, a2.kebabCase = Cd, a2.last = In, a2.lastIndexOf = Uh, a2.lowerCase = Id, a2.lowerFirst = xd, a2.lt = Hp, a2.lte = Np, a2.max = mg, a2.maxBy = wg, a2.mean = Pg, a2.meanBy = Ag, a2.min = Cg, a2.minBy = Ig, a2.stubArray = Hi2, a2.stubFalse = Ni, a2.stubObject = og, a2.stubString = fg, a2.stubTrue = cg, a2.multiply = xg, a2.nth = Wh, a2.noConflict = ng, a2.noop = Di, a2.now = ir2, a2.pad = Ed, a2.padEnd = yd, a2.padStart = Sd, a2.parseInt = Od, a2.random = _d, a2.reduce = ql, a2.reduceRight = Bl, a2.repeat = Rd, a2.replace = bd, a2.result = ad, a2.round = Eg, a2.runInContext = h2, a2.sample = zl, a2.size = Zl, a2.snakeCase = Td, a2.some = Jl, a2.sortedIndex = Kh, a2.sortedIndexBy = Yh, a2.sortedIndexOf = Zh, a2.sortedLastIndex = Jh, a2.sortedLastIndexBy = Xh, a2.sortedLastIndexOf = Qh, a2.startCase = Dd, a2.startsWith = Hd, a2.subtract = yg, a2.sum = Sg, a2.sumBy = Og, a2.template = Nd, a2.times = hg, a2.toFinite = Xn, a2.toInteger = R2, a2.toLength = aa, a2.toLower = $d, a2.toNumber = xn2, a2.toSafeInteger = $p, a2.toString = W2, a2.toUpper = Ud, a2.trim = Wd, a2.trimEnd = Fd, a2.trimStart = Md, a2.truncate = qd, a2.unescape = Bd, a2.uniqueId = pg, a2.upperCase = Gd, a2.upperFirst = Ri, a2.each = Zu, a2.eachRight = Ju, a2.first = Gu, Li(a2, function() {
        ...
        s && (a2.prototype[t] = function() {
          var f2 = this.__wrapped__, c2 = r ? [1] : arguments, l2 = f2 instanceof H2, v2 = c2[0], _2 = l2 || O2(f2), m2 = function(D2) {
            var N2 = s.apply(a2, nt2([D2], c2));
            return r && P2 ? N2[0] : N2;
          };
          _2 && e && typeof v2 == "function" && v2.length != 1 && (l2 = _2 = false);
          var P2 = this.__chain__, I2 = !!this.__actions__.length, E2 = o && !P2, b2 = l2 && !I2;
          if (!o && _2) {
            f2 = b2 ? f2 : new H2(this);
            var y2 = n2.apply(f2, c2);
            return y2.__actions__.push({ func: er2, args: [m2], thisArg: i }), new Pn(y2, P2);
          }
          return E2 && b2 ? n2.apply(this, c2) : (y2 = this.thru(m2), E2 ? r ? y2.value()[0] : y2.value() : y2);
        });
...
var qg = Object.defineProperty, Bg = Object.defineProperties, Gg = Object.getOwnPropertyDescriptors, Ea = Object.getOwnPropertySymbols, zg = Object.prototype.hasOwnProperty, Kg = Object.prototype.propertyIsEnumerable, ya = (C, u2, i) => u2 in C ? qg(C, u2, { enumerable: true, configurable: true, writable: true, value: i }) : C[u2] = i, cr = (C, u2) => {
  for (var i in u2 || (u2 = {}))
...
function Zg(C, u2) {
  ...
  const d2 = [];
  return i.forEach((w2) => {
    const T2 = u2.namespaces[w2].accounts;
    d2.push(...T2);
  }), d2;
}
function Jg(C = {}, u2 = {}) {
...
function Oa(C) {
  ...
  for (const [$2, En] of Object.entries(C)) {
    ...
    T2[Fn2] = Yg(cr(cr({}, T2[Fn2]), En), { chains: S$2(zt2, (u2 = T2[Fn2]) == null ? void 0 : u2.chains), methods: S$2(pr, (i = T2[Fn2]) == null ? void 0 : i.methods), events: S$2(It2, (d2 = T2[Fn2]) == null ? void 0 : d2.events), rpcMap: cr(cr({}, Ln2), (w2 = T2[Fn2]) == null ? void 0 : w2.rpcMap) });
  }
  return T2;
}
function Xg(C) {
...
function Qg(C) {
  ...
  for (const [i, d2] of Object.entries(C)) {
    ...
    u2[i] = { chains: En, methods: w2, events: T2, accounts: $2 };
  }
  return u2;
}
function Wi(C) {
...
class Vg {
  ...
  createHttpProvider(u2, i) {
    const d2 = i || ft(u2, this.namespace, this.client.core.projectId);
    if (!d2)
...
class kg {
  ...
  createHttpProvider(u2, i) {
    const d2 = i || ft(`${this.name}:${u2}`, this.namespace, this.client.core.projectId);
    if (!d2)
      throw new Error(`No RPC url provided for chainId: ${u2}`);
    return new JsonRpcProvider(new HttpConnection(d2, z("disableProviderPing")));
  }
  ...
  async handleSwitchChain(u2) {
    ...
    if (this.isChainApproved(T2))
      ...
      await this.client.request({ topic: u2.topic, request: { method: u2.request.method, params: [{ chainId: w2 }] }, chainId: (d2 = this.namespace.chains) == null ? void 0 : d2[0] }), this.setDefaultChain(`${T2}`);
    else
...
class iv {
  ...
  setDefaultChain(u2, i) {
    if (this.chainId = u2, !this.httpProviders[u2]) {
      const d2 = i || ft(`${this.name}:${u2}`, this.namespace);
      if (!d2)
        throw new Error(`No RPC url provided for chainId: ${u2}`);
  ...
  createHttpProvider(u2, i) {
    const d2 = i || ft(u2, this.namespace);
    return typeof d2 > "u" ? void 0 : new JsonRpcProvider(new HttpConnection(d2, z("disableProviderPing")));
  }
}
var sv = Object.defineProperty, uv = Object.defineProperties, av = Object.getOwnPropertyDescriptors, ba = Object.getOwnPropertySymbols, ov = Object.prototype.hasOwnProperty, fv = Object.prototype.propertyIsEnumerable, Ta = (C, u2, i) => u2 in C ? sv(C, u2, { enumerable: true, configurable: true, writable: true, value: i }) : C[u2] = i, hr = (C, u2) => {
  for (var i in u2 || (u2 = {}))
...
class lr {
  ...
  async disconnect() {
    ...
    await this.client.disconnect({ topic: (u2 = this.session) == null ? void 0 : u2.topic, reason: U$2("USER_DISCONNECTED") }), await this.cleanup();
  }
  async connect(u2) {
    if (!this.client)
      throw new Error("Sign Client not initialized");
  ...
  createProviders() {
    ...
    const u2 = [...new Set(Object.keys(this.session.namespaces).map((i) => Xe$1(i)))];
  ...
  registerEventListeners() {
    ...
    this.client.on("session_ping", (u2) => {
      ...
      var d2;
      const { namespaces: w2 } = i, T2 = (d2 = this.client) == null ? void 0 : d2.session.get(u2);
      this.session = Mi(hr({}, T2), { namespaces: w2 }), this.onSessionUpdate(), this.events.emit("session_update", { topic: u2, params: i });
    }), this.client.on("session_delete", async (u2) => {
      await this.cleanup(), this.events.emit("session_delete", u2), this.events.emit("disconnect", Mi(hr({}, U$2("USER_DISCONNECTED")), { data: u2.topic }));
  ...
  onChainChanged(u2, i = false) {
    ...
    if (!this.namespaces)
      return;
    const [w2, T2] = this.validateChain(u2);
...
function L(a2) {
  const { chains: t, optionalChains: s, methods: i, optionalMethods: n2, events: e, optionalEvents: h2, rpcMap: c2 } = a2;
  if (!D$3(t))
    throw new Error("Invalid chains");
  const o = { chains: t, methods: i || u, events: e || m, rpcMap: p({}, t.length ? { [g(t)]: c2[g(t)] } : {}) }, r = e?.filter((l2) => !m.includes(l2)), d2 = i?.filter((l2) => !u.includes(l2));
  if (!s && !h2 && !n2 && !(r != null && r.length) && !(d2 != null && d2.length))
    return { required: t.length ? o : void 0 };
  const C = r?.length && d2?.length || !s, I2 = { chains: [...new Set(C ? o.chains.concat(s || []) : s)], methods: [...new Set(o.methods.concat(n2 != null && n2.length ? n2 : E))], events: [...new Set(o.events.concat(h2 != null && h2.length ? h2 : _))], rpcMap: c2 };
...
class v {
  ...
  async connect(t) {
    ...
    try {
      const n2 = await new Promise(async (h2, c2) => {
        var o;
  ...
  registerEventListeners() {
    this.signer.on("session_event", (t) => {
      ...
      this.reset(), this.events.emit("session_delete", t), this.events.emit("disconnect", M(p({}, U$2("USER_DISCONNECTED")), { data: t.topic, name: "USER_DISCONNECTED" }));
  ...
  getRpcConfig(t) {
    ...
    const c2 = n2.length ? t?.methods || u : [], o = n2.length ? t?.events || m : [], r = t?.optionalMethods || [], d2 = t?.optionalEvents || [], C = t?.rpcMap || this.buildRpcMap(h2, t.projectId), I2 = t?.qrModalOptions || void 0;
    return { chains: n2?.map((l2) => this.formatChainId(l2)), optionalChains: e.map((l2) => this.formatChainId(l2)), methods: c2, events: o, optionalMethods: r, optionalEvents: d2, rpcMap: C, showQrModal: !!(t != null && t.showQrModal), qrModalOptions: I2, projectId: t.projectId, metadata: t.metadata };
  }
  buildRpcMap(t, s) {
    const i = {};
    return t.forEach((n2) => {
  ...
  async initialize(t) {
    if (this.rpc = this.getRpcConfig(t), this.chainId = this.rpc.chains.length ? g(this.rpc.chains) : g(this.rpc.optionalChains), this.signer = await cv.init({ projectId: this.rpc.projectId, metadata: this.rpc.metadata, disableProviderPing: t.disableProviderPing, relayUrl: t.relayUrl, storageOptions: t.storageOptions }), this.registerEventListeners(), await this.loadPersistedSession(), this.rpc.showQrModal) {
      let s;
      try {
        const { WalletConnectModal: i } = await __vitePreload(() => import("./index.a4ba502d.js").then((n2) => n2.i), true ? ["assets/index.a4ba502d.js","assets/index.a9e8707a.js","assets/index.b35fb805.css"] : void 0);
        s = i;
      } catch {
  ...
  loadConnectOpts(t) {
    ...
    })), i && D$3(i) && (this.rpc.optionalChains = [], this.rpc.optionalChains = i?.map((e) => this.formatChainId(e)), i.forEach((e) => {
      this.rpc.rpcMap[e] = n2?.[e] || this.getRpcUrl(e);
    }));
  }
  getRpcUrl(t, s) {
